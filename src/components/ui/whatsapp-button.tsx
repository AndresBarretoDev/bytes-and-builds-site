...
const WHATSAPP_NUMBER = '573103269651'
const WHATSAPP_MESSAGE =
    'Hola, quiero conocer más sobre sus servicios de desarrollo web y automatización.'
...
export { WHATSAPP_URL, WHATSAPP_NUMBER, WHATSAPP_MESSAGE }
