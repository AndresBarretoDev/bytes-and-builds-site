...
import { TimelineSolid } from '@/components/ui/timeline-solid'
...
/**
 * Timeline Section Component with Solid Blue Titles
 * 
 * Alternative version using solid brand-primary color for titles instead of gradient.
 * Features same content and animations as gradient version.
 */
export function TimelineSolidSection() {
    const data = [
        {
    ...
    return <TimelineSolid data={data} />;
} 